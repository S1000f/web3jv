...
public class TestUtils {
    ...
    public void fromWeiToEtherLength18Test() {
        BigInteger balanceWei = new BigInteger("545109094442210255");
        String result = Utils.fromWei(balanceWei.toString(), EtherUnit.ETHER);
...
//        BigInteger balanceWei = new BigInteger("5451090944422102");
//        String result = Utils.fromWei(balanceWei, EtherUnit.ETHER);
//
...
//        BigInteger balanceWei = new BigInteger("50010909444221025577");
//        String result = Utils.fromWei(balanceWei, EtherUnit.ETHER);
//
...
//        BigInteger balanceWei = new BigInteger("545109094442210255");
//        String result = Utils.fromWei(balanceWei, EtherUnit.GWEI);
//
